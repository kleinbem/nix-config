...
# Non-interactive path for scripted provisioning (e.g. a random passphrase
# generated by an install recipe, fed straight through instead of typed
# twice): set LUKS_PASSPHRASE in the environment to skip the prompt.
