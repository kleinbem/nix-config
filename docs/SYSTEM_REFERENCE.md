...
- 🟢 **Status** (`gatus`) `10.85.48.140:8080` → `status.kleinbem.dev` — Fleet uptime / status page. _[src: nix-presets/containers/gatus.nix:13]_
...
- 🕵️ **Agent Zero** (`agent-zero`) `10.85.50.5:50001` — Autonomous AI agent framework. [AIRLOCK: Restricted Egress] _[src: nix-presets/containers/agent-zero.nix:14]_
...
- 📹 **Frigate NVR** (`frigate`) `10.85.46.39:5000` → `frigate.kleinbem.dev` — NVR with AI object detection (NVIDIA TensorRT). _[src: nix-presets/containers/frigate.nix:32]_
