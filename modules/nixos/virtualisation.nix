    ...
    networking = {
      ...
      firewall = {
        ...
        extraForwardRules = ''
          ...
          iifname "${config.my.network.externalInterface}" oifname "${config.my.network.bridge}" ip saddr { 10.0.0.5, 10.0.0.22, 10.0.0.15, 10.0.0.21, 10.0.0.30, 10.0.0.1, 10.0.0.2, 10.0.0.3, 10.0.0.4, 10.0.0.7, 10.0.0.6 } accept
        ''
