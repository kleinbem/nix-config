    ...
    networking = {
      ...
      firewall = {
        ...
        extraForwardRules = ''
          ...
          iifname "${config.my.network.externalInterface}" oifname "${config.my.network.bridge}" ip saddr { 10.0.0.5, 10.0.0.22, 10.0.0.12, 10.0.0.21, 192.168.1.30, 192.168.1.1, 192.168.1.2, 192.168.1.3, 192.168.1.4, 192.168.1.5, 192.168.1.6 } accept
        ''
